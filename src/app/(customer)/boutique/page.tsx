...
export default function BoutiquePage() {
  ...
  useEffect(() => {
    const cats = searchParams.get('categories')?.split(',').map(Number).filter(Boolean) || [];
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      // Client-side filtering for category, size, color, availability
  ...
  }, [currentPage, priceRange, sortBy, selectedCategories, selectedSizes, selectedColors, availability]);
  ...
  const updateURL = useCallback(() => {
    ...
    router.push(`/customer/boutique?${params.toString()}`, { scroll: false });
  }, [selectedCategories, priceRange, selectedSizes, selectedColors, availability, sortBy, currentPage, router]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-muted py-8 mb-8">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center">Boutique</h1>
